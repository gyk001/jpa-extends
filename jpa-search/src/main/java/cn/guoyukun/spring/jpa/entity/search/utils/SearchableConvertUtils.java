...
import cn.guoyukun.spring.jpa.entity.search.exception.InvalidSearchPropertyException;
import cn.guoyukun.spring.jpa.entity.search.exception.InvalidSearchValueException;
import cn.guoyukun.spring.jpa.entity.search.exception.SearchException;
import cn.guoyukun.spring.jpa.entity.search.filter.AndCondition;
import cn.guoyukun.spring.jpa.entity.search.filter.Condition;
...
public final class SearchableConvertUtils {
     ...
     * value="cn.guoyukun.spring.jpa.entity.search.utils.SearchableConvertUtils.setConversionService"/>
                ...
                if (conversionService == null) {
                    try {
                        ...
                        throw new SearchException("conversionService is null, " +
                                ...
                                "please see [cn.guoyukun.spring.jpa.entity.search.utils." +

...
//    }
    ...
    /**
     * <p>ql条件查询<br/>
     * searchCallback默认实现请参考 {@see cn.guoyukun.spring.jpa.repository.callback.DefaultSearchCallback}<br/>
     * <p/>
     * 测试用例请参考：{@see cn.guoyukun.spring.jpa.repository.UserRepositoryImplForCustomSearchIT}
     * 和{@see cn.guoyukun.spring.jpa.repository.UserRepositoryImplForDefaultSearchIT}
     *
     * @param ql
     ...
     * 具体使用请参考测试用例：{@see cn.guoyukun.spring.jpa.repository.UserRepository2ImplIT#testFindAll()}
     *
     * @param ql
     ...
     * 具体使用请参考测试用例：{@see cn.guoyukun.spring.jpa.repository.UserRepository2ImplIT#testFindOne()}
     *
     * @param ql
     * @param params
     * @param <M>
     ...
     * 具体使用请参考测试用例：cn.guoyukun.spring.jpa.repository.UserRepository2ImplIT#testCountAll()
     *
     * @param ql
     * @param params
     * @return
     ...
     * 具体使用请参考测试用例：{@see cn.guoyukun.spring.jpa.repository.UserRepository2ImplIT#testBatchUpdate()}
     *
     * @param ql
     * @param params
     * @return

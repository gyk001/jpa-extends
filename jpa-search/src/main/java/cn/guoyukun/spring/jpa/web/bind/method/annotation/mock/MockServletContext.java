...
package cn.guoyukun.spring.jpa.web.bind.method.annotation.mock;
 ...
 *
 * <p>Used for testing the Spring mock framework; only rarely necessary for testing
 ...
 * mock application directory, in combination with filesystem-based resource loading.
 * This allows to load the context files as used in the mock application, with
...
public class MockServletContext implements ServletContext {
	 ...
	 * {@link FileTypeMap#getDefaultFileTypeMap() FileTypeMap}

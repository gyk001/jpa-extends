...
public class DefaultSearchCallback implements SearchCallback {
    ...
    protected int genCondition(StringBuilder ql, int paramIndex, SearchFilter searchFilter) {
    ...
    protected int setValues(Query query, SearchFilter searchFilter, int paramIndex) {
        if (searchFilter instanceof Condition) {

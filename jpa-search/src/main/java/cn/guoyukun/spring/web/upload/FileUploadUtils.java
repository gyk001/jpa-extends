 ...
 */
package cn.guoyukun.spring.web.upload;

import cn.guoyukun.spring.utils.LogUtils;
import cn.guoyukun.spring.utils.security.Coder;
...
public class FileUploadUtils {
    ...
    private static final String encodingFilename(String filename) {
    	...
    	filename = Coder.encryptMD5(filename + System.nanoTime() + counter++)+"."+FilenameUtils.getExtension(filename);
        return filename;
    }
